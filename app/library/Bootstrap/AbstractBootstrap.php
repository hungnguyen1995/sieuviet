...
//                    });
    ...
    public function initDB()
    {
        ...
        $this->diContainer->setShared('db', $db);
    }
    ...
    {
        $this->diContainer->setShared('url', function () {
            $url = new Url();
            $url->setBaseUri('');
            return $url;
        });
    ...
    {
        $this->diContainer->setShared('tag', function () {
            $tag = new Tag();
            return $tag;
        });
    }
    ...
    public function initFractal()
    {
        $this->diContainer->setShared('fractal', function () {
            $fractal = new Fractal(new \League\Fractal\Manager);
            return $fractal;
        });
    }
