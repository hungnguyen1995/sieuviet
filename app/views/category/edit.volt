		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="m-portlet">
					...
					<!--begin::Form-->
					<form class="m-form m-form--label-align-right" method="post" action="/blog/category/update/{{data.id}}">
						<div class="m-portlet__body">
							<div class="m-form__section m-form__section--first">
								...
								<div class="form-group m-form__group row">
									...
									<div class="col-lg-6">
										<input type="text" required value="{{data.name}}" name="name" class="form-control m-input" placeholder="Enter Category Name">
									...
									<div class="col-lg-6">
									 	<select class="form-control m-input" name="parent">
									 		...
									 		{% for index, category in categories %}
												<option {% if category.id == data.parent %}  selected {% endif %}  value="{{ category.id}}">{{ category.name}}</option>		
									 		{% endfor %}
									 	</select>
									</div>
								</div>
